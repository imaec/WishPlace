...
class BaseViewModelFactory(private val context: Context) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(SearchResultViewModel::class.java) -> SearchResultViewModel(context) as T
            modelClass.isAssignableFrom(SettingViewModel::class.java) -> SettingViewModel(context) as T
            modelClass.isAssignableFrom(LicenseViewModel::class.java) -> LicenseViewModel(context) as T
